...
public class Servidor {
    ...
    //Creamos una lista de sockets para guardar el socket de cada player
    private LinkedList<Socket> usuarios = new LinkedList<Socket>();
    //Variable para controlar el turno de cada player
   ...
   //Funcion para que el server empieze a recibir conexiones de clientes
    public void escuchar(){
        try {
            ...
            while(true){
                    //Cuando un player se conecte guardamos el socket en nuestra lista
    ...
    //Funcion main para correr el server
