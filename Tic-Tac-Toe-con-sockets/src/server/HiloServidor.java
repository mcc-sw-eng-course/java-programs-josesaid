...
public class HiloServidor implements Runnable{
    ...
    //Variable para guardar que le toco al player X o O
    private int XO;
    //Matriz del juego
    private int G[][];
    //Turno
    private boolean turno;
    //Lista de los usuarios conectados al server
    ...
    public void run() {
        try {
            //Inicializamos los canales de comunicacion y mandamos el turno a cada player
            ...
            //Ciclo infinito que estara escuchando por los movimientos de cada player
            //Cada que un player pone una X o O viene aca y le dice al otro player que es su turno
            while(true){
            ...
            //Si ocurre un excepcion lo mas seguro es que sea por que algun player se desconecto asi que lo quitamos de la lista de conectados
    ...
    //Funcion comprueba si algun player ha ganado el juego
